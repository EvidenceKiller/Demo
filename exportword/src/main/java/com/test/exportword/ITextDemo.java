...
public class ITextDemo {
    ...
    public ITextDemo(Context context) {
        mContext = context;
    }
...
//        String externalFilePath = new StringBuffer(externalDir.getPath()).append("/").toString();
//
//        File outFile = new File(externalFilePath, "itext.doc");
//        if (outFile.exists()) {
//            outFile.delete();
//        }
//        outFile.createNewFile();
//
//        ITextUtils wordUtils = new ITextUtils();
//        wordUtils.openDocument(outFile.getPath());
//
//        //第一级标题样式
...
////        wordUtils.getDocument().add(insertBGColor());
////        wordUtils.getDocument().add(insertComplexTable());
//
